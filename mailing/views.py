...
class ClientCreateView(LoginRequiredMixin, CreateView):
    extra_context = {'title': 'Customer Creation'}
    model = Client
...
class MailingCreateView(LoginRequiredMixin, CreateView):
    extra_context = {'title': 'Newsletter Creation'}
    model = Mailing
...
class MailingDetailView(DetailView):
    extra_context = {'title': 'Newsletter Detail'}
    model = Mailing
...
class LogsListView(ListView):
    extra_context = {'title': 'Newsletter Logs'}
    model = Logs
...
class HomePageView(TemplateView):
    ...
    extra_context = {'title': 'Newsletter Management'}
