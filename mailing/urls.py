...
urlpatterns = [
    ...
    path('mailing_confirm_delete/<int:pk>/', MailingDeleteView.as_view(), name='mailing_delete'),
    ...
    path('client_confirm_delete/<int:pk>/', ClientDeleteView.as_view(), name='client_delete'),
